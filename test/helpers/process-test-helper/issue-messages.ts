...
export const assertionIssues = {
  ...
  scenarioInputKeyBlank: "Input '{{name}}' has a blank value",
  ...
  scenarioSuEntityValuesFieldBlank: "State update for `values` field '{{name}}' has a blank value",
  ...
  scenarioVuRmValuesFieldBlank: "Visible update for `values` field '{{name}}' has a blank value",
  scenarioVuRmNotValuesFieldBlank: "Visible update for `notValues` field '{{name}}' has a blank value",
...
export const fileIssues = {
  ...
  entityFieldMissing: "👽 Entity '{{entityName}}' does not have field: {{name}} ({{fieldTypes}})",
  entityFieldMissingTypes: "👽 Entity '{{entityName}}' field '{{name}}' missing types: {{fieldTypes}}",
  entityNoEventsReduced: "👽 Entity '{{entityName}}' does not reduce any events",

  readModelFileMissing: "🔭 Read Model file missing: '{{filePath}}'",
  readModelFieldMissing: "🔭 Read Model '{{readModelName}}' does not have field: {{name}} ({{fieldTypes}})",
  readModelFieldMissingTypes: "🔭 Read Model '{{readModelName}}' field '{{name}}' missing types: {{fieldTypes}}",
